...
void tst_firstrunwizard::keyPageListsUnusableKeysUnticked() {
  const QString mixed = script(
      ...
      "case \"$*\" in\n"
      "*--list-secret-keys*)\n"
      // echo, not printf: PATH is empty and OpenBSD's ksh has no printf
      // builtin.
      "echo 'sec:e:4096:1:AAAAAAAAAAAAAAAA:1500000000:1600000000::e:::sc:::+:::"
      "23::0:'\n"
      "echo 'fpr:::::::::AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA:'\n"
      "echo 'uid:e::::1500000000::X::Old Key <old@example.org>::::::::::0:'\n"
      "echo 'sec:-:4096:1:BBBBBBBBBBBBBBBB:1774947438:::-:::sc:::+:::23::0:'\n"
      "echo 'fpr:::::::::BBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB:'\n"
      "echo 'uid:-::::1774947438::Y::Untrusted <untrusted@example.org>"
      "::::::::::0:'\n"
      "echo 'sec:u:4096:1:31850CF72D9CDDE9:1774947438:::u:::escarESCA:::+:::23"
      "::0:'\n"
      "echo 'fpr:::::::::13A47CCE2B3DA3AC340A274A31850CF72D9CDDE9:'\n"
      "echo 'uid:u::::1774947438::Z::Anne Jan Brouwer "
      "<anne@example.org>::::::::::0:'\n"
      ";;\n"
      "esac\n"
      "exit 0\n");
