...
<context>
    ...
    <message>
        ...
        <translation type="unfinished">Ένας κάτοχος του κλειδιού υπογραφής το ξεπερνά ανοίγοντας τους «Χρήστες» και αποθηκεύοντας τους παραλήπτες, κάτι που γράφει τη γενιά %1: οι προεπιλεγμένοι παραλήπτες εκεί είναι αυτής της λίστας, οπότε αφαιρέστε πρώτα όποιον δεν θα πρέπει πλέον να έχει πρόσβαση. Η αφαίρεση του %2 ξεχνά όσα είχε αποδεχτεί προηγουμένως αυτή η συσκευή.</translation>
    </message>
    <message>
        ...
        <translation type="unfinished">Η υπογεγραμμένη λίστα παραληπτών %1 δεν περιέχει γραμμή γενιάς, ενώ η γενιά %2 είχε γίνει δεκτή εδώ προηγουμένως. Το pass δεν γράφει γραμμή γενιάς (ούτε μέσω του συστήματος υποστήριξης pass του QtPass), όπως δεν έγραφε ούτε το QtPass πριν από την έκδοση 2.0. %3</translation>
    </message>
    <message>
