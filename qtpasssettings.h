...
public:
    ...
    static int getPasswordCharsSelected(const int &defaultValue = QVariant().toInt());
...
private:
    ...
    static QByteArray getByteArrayValue(const QString &key, const QByteArray &defaultValue);
    ...
    static void setByteArrayValue(const QString &key, const QByteArray &byteArrayValue);
